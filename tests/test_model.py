...
def test_get_input_dict_returns_expected_result():
    expected_result = {
        ...
        "IsHighSeason_0": 1.0,
        "IsHighSeason_1": 0.0,
        "temp_binned_(0.0, 0.19]": 0.0,
        "temp_binned_(0.19, 0.49]": 1.0,
        "temp_binned_(0.49, 0.69]": 0.0,
        "temp_binned_(0.69, 0.89]": 0.0,
        "temp_binned_(0.89, 1.0]": 0.0,
        "hum_binned_(0.0, 0.19]": 0.0,
        "hum_binned_(0.19, 0.49]": 0.0,
        "hum_binned_(0.49, 0.69]": 0.0,
        "hum_binned_(0.69, 0.89]": 1.0,
        "hum_binned_(0.89, 1.0]": 0.0,
    }
